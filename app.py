...
from models import get_user_by_email, verify_password, create_user, insert_artwork, get_db_connection, add_to_cart, get_cart, remove_from_cart, admin_required, login_user, add_favorites, remove_favorites, get_favorites, delete_rejected_artwork
from flask_login import LoginManager, UserMixin, login_user, login_required, logout_user, current_user

app = Flask(__name__)
app.secret_key='sdsjfoe0wu4adj*!fk'
...
@app.route('/approve/<int:artwork_id>', methods=['POST'])
@login_required
@admin_required
...
@app.route('/reject/<int:artwork_id>', methods=['POST'])
@admin_required
@login_required
...
@app.route('/add_to_favorites/<int:artwork_id>', methods=['POST'])
@login_required
def add_to_favorites(artwork_id):
    add_favorites(current_user.id, artwork_id)
    return '', 204

@app.route('/remove_from_favorites/<int:artwork_id>', methods=['POST'])
@login_required
...
@app.route('/remove_from_cart/<int:artwork_id>', methods=['POST'])
@login_required
