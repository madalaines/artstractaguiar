...
def generate_random_artwork(output_dir):
    ...
    print_dimensions = [
        (1024, 1536),  # 4x6 inches
        (1280, 1792),  # 5x7 inches
        (1536, 1920),  # 8x10 inches
        (2480, 3508),  # A4 size 8.3x11.7 inches
    ]

    # Generate random size for the artwork
    width, height = random.choice(print_dimensions)
    ...
    for _ in range(num_shapes):
        ...
        shape = random.choice(["rectangle", "triangle", "ellipse"])
